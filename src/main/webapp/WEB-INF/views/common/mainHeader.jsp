...
<header>
    <nav>
        ...
        <div class="nav-container" style="height: 40px;">
            <div id="type">
                <a href="/book/main" style="margin-right: 5px;font-size: 23px;">웹툰</a>
                <a href="/book/main?page=novel" style="margin-right: 5px;font-size: 23px;">웹소설</a>
            </div>
            <%--<% if (user != null) { %>--%>
            <div id="my-menu">
                ...
                <a href="/mypage/myPage"><i class="fas fa-user fa-xl" style="color: #375890; margin-right: 10px;"></i></a>
